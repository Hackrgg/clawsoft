...
const projects = [
  ...
  },
  {
    id: "nimra",
    title: "Nimra",
    tagline: "Virtual phone numbers & Chrome extension",
    desc: "Chrome extension that gives users virtual US/Canada/UK phone numbers directly in the browser. Call any number with one click, receive inbound calls as popups, and send & receive SMS — all without switching apps.",
    features: ["Click-to-call from any webpage", "Inbound call popups", "SMS conversations", "Multi-number management"],
    tags: ["Chrome Extension", "Web App", "In Progress"],
    url: null,
    accent: "var(--color-teal)",
    logo: "/logos/nimra.png",
    images: ["/work/nimra.png", "/work/nimra-2.png", "/work/nimra-3.png"],
  },
  {
    id: "onyx-gym",
    title: "Onyx Gym",
